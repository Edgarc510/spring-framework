...
//    @Pointcut("execution(* com.myproject.controller.CourseController.*(..))")
...
//    @Before("execution(* com.myproject.controller.CourseController.*(..))")
//    public void beforeAdvice(){
//        logger.info("Logger info ------");
//    }

//    @Pointcut("execution(* com.myproject..repository.CourseRepository.findById(*))")
