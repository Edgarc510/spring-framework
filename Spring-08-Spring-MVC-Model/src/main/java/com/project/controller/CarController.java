...
public class CarController {
    ...
    @RequestMapping("/info") //http://localhost:8080/car/info?make=Honda&model=Civic
    public String carInfo(@RequestParam String make,@RequestParam Integer year, Model model){

        model.addAttribute("make",make);// add make on browser
    ...
    @RequestMapping("/info/{make}/{year}") //http://localhost:8080/car/info/honda/2015
