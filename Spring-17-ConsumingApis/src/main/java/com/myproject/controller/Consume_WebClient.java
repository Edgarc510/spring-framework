...
import com.myproject.entity.Genre;
import com.myproject.entity.MovieCinema;
import com.myproject.repository.GenreRepository;
import com.myproject.repository.MovieCinemaRepository;
...
//    }
    ...
    public Mono<Genre> deleteGenre(@PathVariable("id") Long id){
